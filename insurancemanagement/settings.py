...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = 'autoinsuranceradiant@gmail.com' # this email will be used to send emails
EMAIL_HOST_PASSWORD = 'gdbxbdbkgedrugsc' # host email password required
